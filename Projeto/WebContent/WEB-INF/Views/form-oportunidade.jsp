				...
				<div class='well'>
					...
					<table class="table table-striped opportunity-grid" id="opportunityTable">
						...
						<tbody>
							<tr>
								<td>
									Oportunidade Estágio GFT
								</td>
								<td>
									Vaga de estágio em uma empresa multi-nacional do ramo de TI com grande reconhecimento em Sorocaba.
								</td>
								<td>
									GFT
								</td>
								...
								<td>
									A GFT está dando a oportunidade para os alunos participarem do programa STARTER 2014. A empresa selecionará 20 estagiários para realizarem treinamentos e participações em pequenos projetos internos. 
								</td>
							</tr>
						</tbody>
					</table>
